...
class BasePlatform(core.Construct):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs):
        ...
        self.ecs_cluster = aws_ecs.Cluster.from_cluster_attributes(
            ...
            security_groups=[aws_ec2.SecurityGroup.from_security_group_id(self, "ClusterSecGrp1", cluster_output_sec_grp1), aws_ec2.SecurityGroup.from_security_group_id(self, "ClusterSecGrp2", cluster_output_sec_grp2)],
            vpc=self.vpc,
